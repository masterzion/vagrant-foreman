# /etc/puppetlabs/code/modules/profile/manifests/jenkins.pp
# Ref: https://raw.githubusercontent.com/kalilou/puppet-example/master/code/environments/production/manifests/jenkins_prod.pp
